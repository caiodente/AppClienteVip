...
public class ClienteAdapter extends RecyclerView.Adapter<ClienteAdapter.ViewHolder> {
    ...
    @Override
    /**
     * o onbind é quem vai popular nossa linha lá na tela com as informações:
     */
    public ClienteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View linhaView = inflater.inflate(R.layout.activity_linha_detalhe_cliente, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if(position != RecyclerView.NO_POSITION){
                ...
                Toast.makeText(aContext, "CLiente ID" + position + "Primeiro Nome" + clienteSelecionado.getPrimeiroNome(),
